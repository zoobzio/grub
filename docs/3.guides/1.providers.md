...
| pgvector | `grub/pgvector` | PostgreSQL extension, SQL integration |
...
func main() {
    ...
    index := grub.NewIndex[Embedding](grubpgvector.New(db, grubpgvector.Config{
        Table:          "vectors",
        IDColumn:       "id",
        VectorColumn:   "embedding",
        MetadataColumn: "metadata",
        Distance:       grubpgvector.L2, // or Cosine, InnerProduct
    }))
}
```
...
**Features:**
- Full filter operator support
- Configurable distance metric (L2, Cosine, InnerProduct)
...
| RAG with existing Postgres | pgvector |
...
| Feature | Qdrant | Pinecone | Milvus | pgvector | Weaviate |
|---------|--------|----------|--------|----------|----------|
| Self-hosted | ✓ | ✗ | ✓ | ✓ | ✓ |
| Managed service | ✓ | ✓ | ✓ | ✗ | ✓ |
| Distance metrics | Multiple | Fixed | Multiple | L2/Cosine/IP | Multiple |
| Full filter support | ✓ | ✗ | ✓ | ✓ | ✓ |

### Filter Operator Support (Vector)

| Operator | Qdrant | Pinecone | Milvus | pgvector | Weaviate |
|----------|--------|----------|--------|----------|----------|
| Eq | ✓ | ✓ | ✓ | ✓ | ✓ |
| Ne | ✓ | ✓ | ✓ | ✓ | ✓ |
| Gt/Gte/Lt/Lte | ✓ | ✗ | ✓ | ✓ | ✓ |
